...
function fetchTradeData(trade) {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, query, url, response, data, limitedResults, sortedResults, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    query = encodeURIComponent("".concat(trade, " in Denver, CO"));
                    url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=".concat(query, "&key=").concat(apiKey);
                ...
                case 3:
                    data = _a.sent();
                    limitedResults = data.results.slice(0, MAX_CONTRACTORS);
